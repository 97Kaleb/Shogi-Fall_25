...
/*****************************************************************************************
 * The king can move in any direction. The seoond player's king is actually called the opposing
 * king, so this class is just for the first player.
 ****************************************************************************************/
class King(pos: Position, isWhite: Boolean) : Piece(pos, isWhite) {
    override val symbol: String = "王将"
